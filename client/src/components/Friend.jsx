...
const Friend = ({friendId, name, subtitle, userPicturePath}) => {
    ...
    const patchFriend = async () => {
        const response = await fetch(`https://plant-haven-server.onrender.com/users/${_id}/${friendId}`, {
            method: "PATCH",
        ...
        <FlexBetween>
            <FlexBetween gap="1rem">
                ...
                <Box onClick={() => {
                    ...
                    //FIXME: Bandaid workaround to components not rerendering. refreshes page
                    navigate(0);
                    }}
                >
