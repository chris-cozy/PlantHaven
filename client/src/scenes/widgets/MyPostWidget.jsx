...
const MyPostWidget = ({picturePath}) => {
    ...
    const handlePost = async () => {
        ...
        const response = await fetch(`https://plant-haven-server.onrender.com/posts`, {
            method: "POST",
    ...
    return (
        <WidgetWrapper>
            ...
            <FlexBetween gap="1.5rem">
                ...
                <InputBase placeholder="What're your thoughts?" onChange={(e) => setPost(e.target.value)} value={post} sx={{ width: "100%", backgroundColor: palette.neutral.light, borderRadius: "2rem", padding: "1rem 2rem"}}/>
            </FlexBetween>
            {/** ADDING IMAGES */}
            {isImage && (
