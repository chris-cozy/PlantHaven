...
const NavBar = () => {
    ...
    // Allow the dispatching of actions from reducers
    ...
    return (<FlexBetween padding="1rem 6%" backgroundColor={alt}> 
        ...
        <FlexBetween gap="2rem">
           ...
           <FormControl variant="standard" value={fullName}>
                <Select value={fullName} sx={{backgroundColor: neutralLight, width: "150px", borderRadius: "0.25rem", p: "0.25rem 1rem", "& .MuiSvgIcon-root": {
                pr: "0.25rem",
                width: "3rem"
